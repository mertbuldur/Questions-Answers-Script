                        ...
                        @foreach($data as $k => $v)
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="detail">
                                        <a href="">{{ \App\Comments::getCount($v['id']) }} Yorum</a> - <a href="">{{ \App\Visitor::getCount($v['id']) }} Görüntülenme</a> - <a href="{{ route('view',['selflink'=>$v['selflink'],'id'=>$v['id']]) }}">Devamını Oku</a>
                                    </div>
