                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" method="POST" action="{{ route('settings.store') }}">
                            ...
                            <div class="form-group row">
                                <img style="width:120px;height: 120px;" src="{{ \App\User::getPhoto(\Illuminate\Support\Facades\Auth::id()) }}" alt="">
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="birthdate" required class="form-control" value="{{ Auth::user()->birthdate }}">
                                </div>
                            </div>
