                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                <div class="title">
                                    ...
                                    @foreach(\App\QuestionsCategory::getCategoryList($v['id']) as $k2 => $v2)
                               ...
                               <div class="description">
                                ...
                                <div class="detail">
                                    <a href="">{{ \App\Comments::getCount($v['id']) }} Yorum</a> - <a href="">{{ \App\Visitor::getCount($v['id']) }} Görüntülenme</a> - {{ \App\Helper\mHelper::time_ago($v['created_at']) }} -  <a href="{{ route('view',['selflink'=>$v['selflink'],'id'=>$v['id']]) }}">Devamını Oku</a>
                                </div>
                                @if(\App\Comments::getCount($v['id'])!=0)
                                    <div class="detail">
                                        {{ \App\Comments::getLastComment($v['id']) }}
                                    </div>
                                    @endif
