                        ...
                        <form method="POST" action="{{ route('question.update',['id'=>$data[0]['id']]) }}">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input  type="text" class="form-control" name="title" value="{{ $data[0]['title'] }}" required autofocus>
                                </div>
                            </div>
                                        ...
                                        @foreach($category as $key => $value)
                                            <div class="col-md-3">
                                                <div class="m-checkbox">
                                                    <input type="checkbox"  @if(\App\QuestionsCategory::isChecked($value['id'],$data[0]['id'])) checked @endif name="category[]" value="{{ $value['id'] }}">
                                                    {{ $value['name'] }}
                                                </div>
                                            </div>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="text" id="question--area" class="form-control" cols="30" rows="10">{{ $data[0]['text'] }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="tags" id="tokenfield" class="form-control" value="{{ \App\QuestionsTags::getImplode($data[0]['id']) }}">
                                </div>
                            </div>
